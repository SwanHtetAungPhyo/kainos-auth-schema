...
CREATE INDEX IF NOT EXISTS idx_trusted_device_device ON "trusted_device"(device_id);
...
CREATE INDEX IF NOT EXISTS idx_org_role_org ON "organization_role"(organization_id);
